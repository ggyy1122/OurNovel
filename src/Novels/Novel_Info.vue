...
.tag-row {
    ...
    gap: 12px;
    margin-bottom: 12px; /* 统一控制与下方内容的间距 */
}
...
.book-title {
    ...
    margin: 0; /* 移除所有margin */
    line-height: 1.3;
    display: inline-flex; /* 确保参与flex布局的对齐 */
...
/* 数字部分 */
.stat-value {
  font-size: 15px;    /* 比原文字大1px */
  font-weight: 600;   /* 半粗体 */
  color: #1e293b;     /* 深灰色（接近黑） */
}

/* 单位部分 */
.stat-unit {
  font-size: 13px;    /* 比数字小2px */
  font-weight: 400;    /* 正常粗细 */
  color: #64748b;     /* 中灰色 */
  margin-left: 2px;    /* 与数字微间距 */
}
...
.newest-chapter {
  ...
  letter-spacing: 0.3px;        /* 轻微字距 */
  margin: 8px 0 12px 0;         /* 上下间距 */
  padding: 6px 0;               /* 内边距 */
  display: flex;
  align-items: center;
  gap: 8px;
